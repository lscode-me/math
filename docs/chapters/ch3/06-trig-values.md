...
# Глава 6. Точные значения синусов и косинусов

## 6.1. Зачем считать руками?
...
| Угол $\alpha$ | $\sin \alpha$ | $\cos \alpha$ | $\tan \alpha$ |
|:---:|:---:|:---:|:---:|
| $0°$ | $0$ | $1$ | $0$ |
...
## 6.3. Формулы сложения — главный инструмент
...
## 6.5. Пятиконечная звезда и угол 36°
...
!!! tip "Связь с золотым сечением"
    $\cos 36° = \frac{\varphi}{2}$, где $\varphi = \frac{1+\sqrt{5}}{2}$ — золотое сечение. Пятиугольник «пропитан» золотым сечением: отношение диагонали к стороне, отношение частей диагонали, косинус $36°$ — всё выражается через $\varphi$.
...
## 6.7. Почему $\sin 1°$ нельзя вычислить (в обычных радикалах)
...
$Q < 0$ — это в точности **casus irreducibilis** из Главы 5! Кубическое уравнение имеет три вещественных корня (а именно $\sin 1°$, $\sin 59°$, $-\sin 61°$), но формула Кардано выражает их через **комплексные** кубические корни.
...
## 6.8. Какие углы допускают точное вычисление?
...
## 6.9. Итоговая «карта» вычислимых углов
...
!!! abstract "Резюме главы"
    ...
    - $\sin 1°$ **не** выражается в квадратных радикалах — трисекция $3°$ сводится к **кубическому уравнению** с $Q < 0$ (casus irreducibilis, Глава 5)
...
**6.1.** Вычислите $\sin 75°$ и $\cos 75°$, используя $75° = 45° + 30°$.

??? note "Ответ"
    $\sin 75° = \cos 15° = \frac{\sqrt{6}+\sqrt{2}}{4}$, $\cos 75° = \sin 15° = \frac{\sqrt{6}-\sqrt{2}}{4}$.

**6.2.** Проверьте, что $\sin^2 18° + \cos^2 18° = 1$, подставив точные значения.

??? note "Ответ"
    $\sin^2 18° = \frac{6-2\sqrt{5}}{16}$, $\cos^2 18° = \frac{10+2\sqrt{5}}{16}$. Сумма $= \frac{16}{16} = 1$. ✓

**6.3.** Вычислите $\cos 54°$ двумя способами: (а) как $\sin 36°$; (б) из формулы $54° = 90° - 36°$.
...
**6.4.** Найдите $\cos 36° - \cos 72°$ и объясните результат.
...
**6.5.** Выразите $\sin 9°$ через радикалы. (*Подсказка: $9° = \frac{18°}{2}$, используйте формулу половинного угла.*)

??? note "Ответ"
    $\sin 9° = \sqrt{\frac{1 - \cos 18°}{2}} = \sqrt{\frac{1 - \frac{\sqrt{10+2\sqrt{5}}}{4}}{2}} = \frac{1}{2}\sqrt{2 - \frac{\sqrt{10+2\sqrt{5}}}{2}}$.

**6.6.** Покажите, что $4\sin^3 1° - 3\sin 1° + \sin 3° = 0$. Объясните, почему это не помогает найти $\sin 1°$ в радикалах.
...
**6.7.** Докажите, что $\cos 20°$ является корнем уравнения $8t^3 - 6t - 1 = 0$, и покажите, что это уравнение попадает в casus irreducibilis. (*Подсказка: $3 \times 20° = 60°$.*)
...
**6.8.** Докажите тождество $\sin 18° \cdot \sin 54° = \frac{1}{4}$. (*Подсказка: выразите через $\varphi$.*)
