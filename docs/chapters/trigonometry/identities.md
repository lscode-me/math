...
!!! tip "Что дальше"
    Тождества — инструмент упрощения. В [§3.3 «Тригонометрические уравнения и неравенства»](equations.md) мы применим их для решения уравнений: как записать бесконечное множество решений, как не потерять корни при преобразованиях, и что делать с тригонометрическими неравенствами.
