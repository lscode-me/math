...
!!! abstract "Резюме главы"
    ...
    - $\sin 1°$ **не** выражается в квадратных радикалах — трисекция $3°$ сводится к **кубическому уравнению** с $Q < 0$ (casus irreducibilis, [§2.3](../algebra/cubic.md))
...
!!! tip "Что дальше"
    Мы научились вычислять точные значения для отдельных углов. В [§3.2 «Тригонометрические тождества»](identities.md) мы разберём общие соотношения между тригонометрическими функциями: формулы произведения, суммы и разности, а также мощные методы упрощения и доказательства тождеств.
