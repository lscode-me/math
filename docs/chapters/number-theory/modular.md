...
!!! tip "Что дальше"
    Модулярная арифметика работает с остатками. В [§10.2 «Диофантовы уравнения»](diophantine.md) мы будем искать целочисленные решения: линейные уравнения, пифагоровы тройки, Великая теорема Ферма и уравнение Пелля — задачи, где требуется не «любое» решение, а точно целое.
